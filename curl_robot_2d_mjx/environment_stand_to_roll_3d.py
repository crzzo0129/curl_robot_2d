    ...
    class StandToRollEnv(Env):
        ...
        def _zero_metrics(self, distance, alpha, root_z):
            ...
            return {
                ...
                **{f"torque_{i}_{suffix}": zero for i in range(12)
                   for suffix in ("peak_nm", "square_integral", "over2_s", "at3_s")},
                "lateral_cost": zero,
        ...
        def step(self, state, action):
            ...
            metrics = {
                ...
                **{f"torque_{i}_over2_s": jp.sum(torque_abs[:, i] > 2.0) * self.physics_timestep for i in range(12)},
                **{f"torque_{i}_at3_s": jp.sum(torque_abs[:, i] >= 2.99) * self.physics_timestep for i in range(12)},
